...
def sample_one_step_ahead(
    ...
    for t in range(1, T):
        ...
        yt_dist = (
            ...
            + np.sum(ssp.loggamma(dir0 + yt[t] + ysum), axis=1)
...
def init_gibbs(rho0, rho1, alpha0, gamma0, dir0, T, yt):
    ...
    zt, wt, n_mat, ysum, beta_vec, kappa_vec, beta_new, kappa_new, K = (
...
def sample_zw(
    ...
    zt, wt, n_mat, ysum, beta_vec, kappa_vec, beta_new, kappa_new, K = sample_last(
        zt,
        wt,
        yt,
        n_mat,
