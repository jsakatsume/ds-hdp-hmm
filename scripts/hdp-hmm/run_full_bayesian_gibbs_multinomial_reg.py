...
for it in range(iters):
    if it == 0:
        alpha0, gamma0, dir0, K, zt, beta_vec, beta_new, n_mat, ysum = (
            init_gibbs_full_bayesian_regular(
                alpha0_a_pri, alpha0_b_pri, gamma0_a_pri, gamma0_b_pri, dir0, T, yt_real
            )
        )
    else:
        zt, n_mat, ysum, beta_vec, beta_new, K = sample_zw(
            zt, yt_real, n_mat, ysum, beta_vec, beta_new, alpha0, gamma0, dir0, rho0, K
        )
