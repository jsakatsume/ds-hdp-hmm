...
## nohup python run_full_bayesian_approx_parallel_gibbs_poisson_reg.py 1 20 2 'prior' i01_maze15_2d_data_100ms_sample_trials ./ 200 &
...
for it in range(iters):
    ...
    m_mat, m_init, _, _ = sample_m_w_mbar(
    ...
    ## sample hyperparams
    alpha0, alpha0_init = sample_concentration(
        m_mat,
        n_mat,
        alpha0,
        rho0,
    ...
    ## compute loglik
    if it % 10 == 0:
        loglik_test = compute_log_marginal_lik_poisson_fmp(
