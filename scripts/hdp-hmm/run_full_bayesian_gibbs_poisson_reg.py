...
## nohup python run_full_bayesian_gibbs_poisson_reg.py 1 20 i01_maze15_2d_data_100ms_sample_trials ./ &
...
for it in range(iters):
    if it == 0:
        (
            ...
            ysum,
            ycnt,
        ) = init_gibbs_full_bayesian_regular(
            alpha0_a_pri,
            alpha0_b_pri,
            gamma0_a_pri,
            gamma0_b_pri,
        ...
        zt, n_mat, ysum, ycnt, beta_vec, beta_new, K = sample_zw(
            zt,
            yt_real,
            n_mat,
            ysum,
    ...
    ## sample hyperparams
    alpha0 = sample_concentration(
        m_mat, n_mat, alpha0, rho0, alpha0_a_pri, alpha0_b_pri
    )
    ...
    if it % 10 == 0:
        ...
        hyperparam_sample.append(np.hstack((np.array([alpha0, gamma0]), lam_b_pri)))
